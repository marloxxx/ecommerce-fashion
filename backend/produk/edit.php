    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container-xl px-4 mt-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">Edit Jenis Produk</div>
                    <div class="card-body">
                        <form id="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="kode" name="kode" type="text" placeholder="Kode" value="<?= $produk['kode'] ?>" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (nama)-->
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="nama" name="nama" type="text" placeholder="Nama" value="<?= $produk['nama'] ?>" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (harga)-->
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="harga" name="harga" type="text" placeholder="Harga" value="<?= $produk['harga'] ?>" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (stok)-->
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="stok" name="stok" type="text" placeholder="Harga" value="<?= $produk['stok'] ?>" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (jenis_produk)-->
                                <div class="col-md-12">
                                    <label class="small mb-1" for="jenis_produk">Jenis Produk</label>
                                    <select class="form-control" id="jenis_produk" name="jenis_produk">
                                        <option value="">Pilih Jenis Produk</option>
                                        <?php
                                        foreach ($result as $row) {
                                            echo "<option value='$row[nama]' " . ($produk['jenis_produk'] == $row['nama'] ? 'selected' : '') . ">$row[nama]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
